...
static const yytype_int8 yyrhs[] =
{
      ...
      -1,    21,    -1,    24,    -1,     6,    -1,     7,    -1,     8,
      -1,     4,    -1,     5,    -1,     3,    -1,     9,    10,    -1,
       9,    22,    10,    -1,    23,    -1,    23,    13,    22,    -1,
       3,    14,    16,    -1,    11,    12,    -1,    11,    25,    12,
      -1,    16,    -1,    16,    13,    25,    -1
};
...
{
       0,   321,   321,   324,   327,   330,   333,   336,   342,   349,
     359,   368,   376,   387,   398,   404,   410,   417,   424,   435,
     441,   447,   454
};
#endif
...
{
  "$end", "error", "$undefined", "TOKEN_STRING", "TOKEN_INTEGER",
  "TOKEN_DECIMAL", "TOKEN_TRUE", "TOKEN_FALSE", "TOKEN_NULL",
  "TOKEN_LBRACE", "TOKEN_RBRACE", "TOKEN_LBRACKET", "TOKEN_RBRACKET",
  "TOKEN_COMMA", "TOKEN_COLON", "$accept", "value", "boolean", "null",
  "number", "string", "object", "members", "member", "array", "elements", 0
};
#endif
...
{
       0,    13,    11,    12,     8,     9,    10,     0,     0,     0,
       2,     3,     4,     5,     6,     7,     0,    14,     0,    16,
      19,    21,     0,     1,     0,    15,     0,     0,    20,    18,
      17,    22
};
...
{
       8,    -7,    -7,    -7,    -7,    -7,    -7,    15,    -2,    20,
      -7,    -7,    -7,    -7,    -7,    -7,    -6,    -7,    11,     9,
      -7,    10,    14,    -7,     8,    -7,    24,     8,    -7,    -7,
      -7,    -7
};
...
{
       9,     1,     2,     3,     4,     5,     6,     7,    24,     8,
      20,     1,     2,     3,     4,     5,     6,     7,    16,     8,
      23,    25,    26,    27,    29,    17,    28,    16,    30,     0,
      31
};

static const yytype_int8 yycheck[] =
{
       0,     3,     4,     5,     6,     7,     8,     9,    14,    11,
      12,     3,     4,     5,     6,     7,     8,     9,     3,    11,
       0,    10,    13,    13,    24,    10,    12,     3,    26,    -1,
      27
};
...
static const yytype_uint8 yystos[] =
{
      ...
      17,    18,    19,    20,    21,    24,     3,    10,    22,    23,
      12,    16,    25,     0,    14,    10,    13,    13,    12,    16,
      22,    25
};
...
/*ARGSUSED*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_symbol_value_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, struct ast *ast)
#else
static void
...
`--------------------------------*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_symbol_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, struct ast *ast)
#else
static void
...
`------------------------------------------------*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_reduce_print (YYSTYPE *yyvsp, int yyrule, struct ast *ast)
#else
static void
...
/*ARGSUSED*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yydestruct (const char *yymsg, int yytype, YYSTYPE *yyvaluep, struct ast *ast)
#else
static void
...
/* Line 1455 of yacc.c  */
#line 368 "src/json/json.y"
    {
        int64_t value = atoll((yyvsp[(1) - (1)].litera).image);
...
/* Line 1455 of yacc.c  */
#line 376 "src/json/json.y"
    {
        double value = atof((yyvsp[(1) - (1)].litera).image);
        struct json_number_node *json = calloc(1, sizeof(struct json_number_node));
        json->super.tree = ast;
...
/* Line 1455 of yacc.c  */
#line 387 "src/json/json.y"
    {
        struct json_string_node *json = calloc(1, sizeof(struct json_string_node));
        json->super.tree = ast;
        json->super.type = JSON_NODE_TYPE_STRING;
        json->value = strndup((yyvsp[(1) - (1)].litera).image + 1, (yyvsp[(1) - (1)].litera).length - 2);
        json->length = (yyvsp[(1) - (1)].litera).length;
        (yyval.node) = AST_NODE(json);
      }
    break;
...
/* Line 1455 of yacc.c  */
#line 404 "src/json/json.y"
    {
        (yyval.node) = AST_NODE((yyvsp[(2) - (3)].node));
      }
    break;
...
/* Line 1455 of yacc.c  */
#line 410 "src/json/json.y"
    {
        struct json_object_node *json = calloc(1, sizeof(struct json_object_node));
        json->super.tree = ast;
        json->super.type = JSON_NODE_TYPE_OBJECT;
        ast_node_add_child(AST_NODE(json), AST_NODE((yyvsp[(1) - (1)].node)));
        (yyval.node) = AST_NODE(json);
      }
    break;
...
/* Line 1455 of yacc.c  */
#line 417 "src/json/json.y"
    {
        ast_node_add_child((yyvsp[(3) - (3)].node), AST_NODE((yyvsp[(1) - (3)].node)));
...
/* Line 1455 of yacc.c  */
#line 424 "src/json/json.y"
    {
        struct json_member_node *json = calloc(1, sizeof(struct json_member_node));
        json->super.tree = ast;
        json->super.type = JSON_NODE_TYPE_MEMBER;
        json->name = strndup((yyvsp[(1) - (3)].litera).image + 1, (yyvsp[(1) - (3)].litera).length - 2);
        json->value = AST_NODE((yyvsp[(3) - (3)].node));
        (yyval.node) = AST_NODE(json);
      }
    break;
